...
const UserPanel = ({ user, setUser}:UserPanelProps) => {
    ...
    return (
        <div className="z-30 fixed inset-0 flex items-center justify-center bg-gray-900 bg-opacity-50 transition-opacity">
            <div className="flex flex-row w-[600px] h-[400px] bg-white m-auto overflow-hidden">
