...
const LibraryCard = () => {
    ...
    return (
        <div className="flex justify-between relative flex-col items-center md:flex-row md:items-start">
            <div className="flex flex-col w-[600px] items-center mb-[41px]">
                <h3 className="text-[30px] tracking-[0.6px] mb-[30px]">{auth ? "Your Library card" : "Find your Library card"}</h3>
                <form className="flex flex-col w-full items-center box-border border-[3px] border-[#BB945F] p-[20px]">
                    <div className="pt-[20px] px-[20px] bg-[#BB945F] mb-[15px] w-full">
                        <p className="text-[30px] mb-[20px] tracking-[0.6px] font-forum leading-[50px]">Brooklyn Public Library</p>
                        {!auth ? <>
                                    <input className="w-full mb-[25px] px-[20px] py-[8px] rounded-[10px] text-[30px] text-[#8E8E8E] leading-[50px] font-forum tracking-[0.6px]" type="text" placeholder="Reader's name"/>
                                    <input className="w-full mb-[25px] px-[20px] py-[8px] rounded-[10px] text-[30px] text-[#8E8E8E] leading-[50px] font-forum tracking-[0.6px]" type="text" placeholder="Card number"/>
                                </>
                            :   <>
                                    <p className="w-full mb-[25px] px-[20px] py-[8px] rounded-[10px] text-[30px] bg-white text-[#BB945F] leading-[50px] font-forum tracking-[0.6px]" >{user.firstname}</p>
                                    <p className="w-full mb-[25px] px-[20px] py-[8px] rounded-[10px] text-[30px] bg-white text-[#BB945F] leading-[50px] font-forum tracking-[0.6px]" >F00234030</p>
                                </>
                        }
                    </div>
                    {auth 
