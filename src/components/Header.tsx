...
const Header = () => {
    ...
    <header className="flex relative items-center justify-between max-w-[1440px] h-[90px] bg-black">
        ...
        <div className="flex flex-row px-5 items-center justify-center">
            ...
            { auth ? <p>{`${userData.firstname[0]} ${userData.lastname[0]}`}</p> : <a className="block ml-[40px] cursor-pointer"onClick={()=>setMenuUser(!menuUser)}><svg width="28" height="28" viewBox="0 0 28 28" fill="none" xmlns="http://www.w3.org/2000/svg">
