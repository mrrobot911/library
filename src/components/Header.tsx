...
const Header = () => {
    ...
    <header className="flex relative items-center justify-between max-w-[1440px] h-[90px] bg-[#0C0C0E]">
        ...
        <div className="flex flex-row px-5 items-center justify-center">
            ...
            > 
                <div className={isMenuOpen ? "h-[2px] w-[44px] bg-white rounded-[2px] transition-[0.3s] -rotate-45 translate-y-[1px]" : "h-[2px] w-[100%] bg-white rounded-[2px] transition-[0.3s] translate-y-[-8px]"}></div>
